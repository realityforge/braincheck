...
This workflow publishes BrainCheck to Maven Central using the split release scripts in this directory. Run commands
...
The package command writes `dist/braincheck-<version>/` and `dist/braincheck-<version>.zip`.
