...
public class GuardsTest extends AbstractTest {
    @Test
    public void fail() {
    ...
    public void invariant_failed() {
        final IllegalStateException exception = expectThrows(
                IllegalStateException.class, () -> Guards.invariant(() -> false, () -> "My Failure Reason"));
    ...
    public void apiInvariant_failed() {
        final IllegalStateException exception = expectThrows(
                IllegalStateException.class, () -> Guards.apiInvariant(() -> false, () -> "My Failure Reason"));
