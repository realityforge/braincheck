...
### [v#{ENV['PRODUCT_VERSION']}](https://github.com/realityforge/braincheck/tree/v#{ENV['PRODUCT_VERSION']}) (#{ENV['RELEASE_DATE']}) · [Full Changelog](https://github.com/realityforge/braincheck/compare/#{from}...v#{ENV['PRODUCT_VERSION']})
HEADER
